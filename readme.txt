...
oceanpayment Konbini payment  plugin

== Description ==
oceanpayment Konbini payment  plugin

== Installation ==
1.install the Oceanpayment-Konbini plug-in in the WordPrwss background.
2.Activate oceanpayment Konbini in the plugin menu.
